# [💻 LiveTerm - build terminal styled websites in minutes!](https://bgaportfolio.vercel.app)
...
```bash
sh -c "$(curl -fsSL https://raw.githubusercontent.com/bashebr/bgaportfolio/main/install/install.sh)"
```
...
```bash
git clone https://github.com/bashebr/bgaportfolio.git && cd LiveTerm
```
...
Based on Cveinnt's awesome [Terminal](https://github.com/Cveinnt/LiveTerm.git)
